      ...
      <div className="footer_bg">
        <div className="container custom_container py-4">
          ...
          <div className="d-flex justify-content-center gap-4">
            <button className="d-flex gap-2 align-items-center common_btn lh_21 fw_medium font_md text-black border-transparent border-1">
              <span>
                <img src={startWritingImg} alt="start-writing-icon-img" />
              </span>
              Start Writing
            </button>
            <button className="common_btn lh_21 fw_medium font_md text-black border-transparent border-1">
              Get the app
            </button>
          </div>
